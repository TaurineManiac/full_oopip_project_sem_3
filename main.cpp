    ...
    while (true) {
        ...
        switch (numOfLabChoice) {
            ...
            case 2:
                ...
                break;
            case 3:
                cout << "В каждом индивидуальном задании необходимо создать контейнеры list, vector, array,"
                        " которые будут хранить объекты классов по предметной области, указанной в таблице "
                        "(класс должен содержать функционал по предметной области (добавление, удаление, редактирование, поиск, фильтр данных))."
                        " Для контейнера реализовать добавление, удаление, редактирование, вывод содержимого контейнера на экран и в файл,"
                        " поиск и сортировку элементов."
                        " Необходимо создать удобное пользовательское меню для тестирования всех реализованных функций.  " << endl;
